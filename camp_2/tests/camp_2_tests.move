...
module camp_2::camp_2_tests {
    ...
    #[test, expected_failure(abort_code = ::camp_2::camp_2_tests::ENotImplemented)]
    fun test_camp_2_fail() {
...
#[test_only]
module camp_2::kapy_tests {

    use std::string::utf8;
    use sui::test_scenario::{Self as ts, Scenario};
    use camp_2::config::{Self, AdminCap};
    use camp_2::kapy::{Self, MintCap, Kapy};
    ...
    #[test, expected_failure(abort_code = camp_2::kapy::ECarrySameKindOfOrange)]
